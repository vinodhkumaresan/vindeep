//Circulated Water Data
var mainApp = angular.module('clair.controller.cwController', ['angularChart']);

mainApp.controller('clair.controller.cwController', ['$scope', '$http', function($scope, $http) {       
